        ...
        <div class="menu-reponsive" id="menu">
            ...
            <div class="nav-vertical-re" id="nav-show">
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link dot"><img src="{{ asset('images/home.svg') }}" alt=""> View
                            site</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link dot"><img src="{{ asset('images/file-plus.svg') }}"
                                alt="">Create
                            page</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link dot"><img src="{{ asset('images/pen-tool.svg') }}" alt="">Blog
                            articles</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link dot"><img src="{{ asset('images/trash-2.svg') }}"
                                alt="">Archived
                            pages</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link dot"><img src="{{ asset('images/book-open.svg') }}"
                                alt="">Themes</a>
                    </li>
                    <li class="nav-item">
