            ...
            <div class="content">
                <div class="form-login">
                    <form action="{{url('/docreatepage')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <input required name="img" id="img"
                        oninvalid="setCustomValidity('Ảnh không được để trống.')"
                        onchange="try{setCustomValidity('')}catch(e){}"
                        type="hidden" class="input-email" value="{{Session::get('image')}}" >
                        ...
                        placeholder="Title" 
                        required
                        oninvalid="setCustomValidity('Tiêu đề không được để trống.')"
                        onchange="try{setCustomValidity('')}catch(e){}"
                        value="{{old('title')}}">
                        ...
                        required
                        oninvalid="setCustomValidity('Mô tả không được để trống.')"
                        onchange="try{setCustomValidity('')}catch(e){}"
                        ...
                        required
                        oninvalid="setCustomValidity('Địa điểm không được để trống.')"
                        onchange="try{setCustomValidity('')}catch(e){}"
                        placeholder="Place">{{old('place')}}</textarea>
